...
namespace ZbudujmyDom
{
    public partial class Form1 : Form
    {
        ...
        private void CreateObjects()
        {
            ...
            livingRoom = new RoomWithDoor("Salon", "antyczny dywan", "w szafie œciennej", "dêbowe drzwi mosiê¿n¹ klamk¹");
            ...
            masterBedroom = new RoomWithHidingPlace("Du¿a sypialnia", "ma³e ³ó¿ko", "pod ³ó¿kiem");
